...
@snoop
def permut_sig_connection(preproc_files: str, sig_connection_path: str, n_permutations: int):
        ...
        for participant1_channel in range(len(ch_names)):
            for participant2_channel in range(len(ch_names)):
                ...
                for iperm in range(n_perms):
                    ...
                    # for participant 2
                    # TODO : Delete the commented line below when ready to be save
                    ...
                    data_inter_permuted = np.array([epoch1_in_permuted_order, epoch2_in_permuted_order])
