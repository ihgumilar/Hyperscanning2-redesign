...
# Save the scores of inter-brain synchrony from each pair into pkl file
with open(
    "list_circular_correlation_scores_all_pairs_averted_baseline_pre_no_filter.pkl",
    "wb",
) as handle:
    pickle.dump(
        list_circular_correlation_averted_baseline_pre_no_filter_all,
...
# Save the scores of inter-brain synchrony from each pair into pkl file
with open(
    "list_circular_correlation_scores_all_pairs_averted_baseline_post_no_filter.pkl",
    "wb",
) as handle:
    pickle.dump(
        list_circular_correlation_averted_baseline_post_no_filter_all,
