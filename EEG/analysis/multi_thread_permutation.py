...
# %% [markdown]
# ## Function for permutation : to find significant connection

# %%
def permutation_2_find_significant_connections(preproc_files_path: str, saved_directory_path: str, n_perms:int, eye_condition:str):
    ...
    list_of_files = os.listdir(preproc_files_path)

    # Change working directory
    os.chdir(preproc_files_path)
...
# %% [markdown]
# ## Run function for permutation

# %%
# Averted pre
preproc_averted_pre_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/pre-processed_eeg_data/raw_preproc_experiment_epoched_data/averted_pre/"
saved_directory_averted_pre_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/significant_connections/averted_pre/"

# Averted post
preproc_averted_post_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/pre-processed_eeg_data/raw_preproc_experiment_epoched_data/averted_post/"
saved_directory_averted_post_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/significant_connections/averted_post/"

# Direct pre
preproc_direct_pre_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/pre-processed_eeg_data/raw_preproc_experiment_epoched_data/direct_pre/"
saved_directory_direct_pre_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/significant_connections/direct_pre/"

# Direct post
preproc_direct_post_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/pre-processed_eeg_data/raw_preproc_experiment_epoched_data/direct_post/"
saved_directory_direct_post_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/significant_connections/direct_post/"

# Natural pre
preproc_natural_pre_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/pre-processed_eeg_data/raw_preproc_experiment_epoched_data/natural_pre/"
saved_directory_natural_pre_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/significant_connections/natural_pre/"

# Natural post
preproc_natural_post_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/pre-processed_eeg_data/raw_preproc_experiment_epoched_data/natural_post/"
saved_directory_natural_post_path = "/hpc/igum002/codes/Hyperscanning2-redesign/data/EEG/significant_connections/natural_post/"
...
#     t = Thread(target=task, args=(i,"averted_pre"))
#     total_thread.append(t)
#     # t2 = Thread(target=task)

# # start the threads
# for t in total_thread:
#     t.start()
...
# Define the thread for each eye condition
t_averted_post = Thread(target=permutation_2_find_significant_connections, args=(preproc_averted_post_path, saved_directory_averted_post_path, 150, "averted_post"))
t_natural_pre = Thread(target=permutation_2_find_significant_connections, args=(preproc_natural_pre_path, saved_directory_natural_pre_path, 150, "natural_pre"))
t_natural_post = Thread(target=permutation_2_find_significant_connections, args=(preproc_natural_post_path, saved_directory_natural_post_path, 150, "natural_post"))
t_direct_pre = Thread(target=permutation_2_find_significant_connections, args=(preproc_direct_pre_path, saved_directory_direct_pre_path, 150, "direct_pre"))
t_direct_post = Thread(target=permutation_2_find_significant_connections, args=(preproc_direct_post_path, saved_directory_direct_post_path, 150, "direct_post"))

# start the threads
t_averted_post.start()
t_natural_pre.start()
t_natural_post.start()
t_direct_pre.start()
t_direct_post.start()
