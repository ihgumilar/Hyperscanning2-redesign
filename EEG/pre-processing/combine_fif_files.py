...
for i in tqdm(range(begin, end, step), desc="Just relax and drink your coffee.."):
    ...
    # Pre-averted
    averted_pre_right_odd_subject = mne.io.read_raw_fif(
        "EEG-S0" + str(i + 2) + "-averted_pre_right_point_raw.fif", verbose=False
    )
    averted_pre_left_odd_subject = mne.io.read_raw_fif(
    ...
    # Post-averted
    averted_post_right_odd_subject = mne.io.read_raw_fif(
        "EEG-S0" + str(i + 2) + "-averted_post_right_point_raw.fif", verbose=False
    )
    averted_post_left_odd_subject = mne.io.read_raw_fif(
        "EEG-S0" + str(i + 2) + "-averted_post_left_point_raw.fif", verbose=False
    )
    averted_post_files_to_combine = [
        averted_post_right_odd_subject,
        averted_post_left_odd_subject,
    ...
    #  Post-directed
    direct_post_right_odd_subject = mne.io.read_raw_fif(
        "EEG-S0" + str(i + 2) + "-direct_post_right_point_raw.fif", verbose=False
    )
    direct_post_left_odd_subject = mne.io.read_raw_fif(
    ...
    #  Pre-natural
    natural_pre_right_odd_subject = mne.io.read_raw_fif(
        "EEG-S0" + str(i + 2) + "-natural_pre_right_point_raw.fif", verbose=False
    )
    natural_pre_left_odd_subject = mne.io.read_raw_fif(
    ...
    #  Post-natural
    natural_post_right_odd_subject = mne.io.read_raw_fif(
        "EEG-S0" + str(i + 2) + "-natural_post_right_point_raw.fif", verbose=False
    )
    natural_post_left_odd_subject = mne.io.read_raw_fif(
        "EEG-S0" + str(i + 2) + "-natural_post_left_point_raw.fif", verbose=False
    )
    natural_post_files_to_combine = [
        natural_post_right_odd_subject,
        natural_post_left_odd_subject,
...
for i in tqdm(range(begin, end, step), desc="Just relax and drink your coffee.."):
    ...
    if i == 10:
        ...
        # Post-averted
        averted_post_right_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i) + "-averted_post_right_point_raw.fif", verbose=False
        )
        averted_post_left_odd_subject = mne.io.read_raw_fif(
        ...
        # Post-natural
        natural_post_right_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i) + "-natural_post_right_point_raw.fif", verbose=False
        )
        natural_post_left_odd_subject = mne.io.read_raw_fif(
    ...
    if i + 2 > 10:
        # Pre-averted
        averted_pre_right_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-averted_pre_right_point_raw.fif", verbose=False
        )
        averted_pre_left_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-averted_pre_left_point_raw.fif", verbose=False
        )
        averted_pre_files_to_combine = [
            averted_pre_right_odd_subject,
            averted_pre_left_odd_subject,
        ...
        # Post-averted
        averted_post_right_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-averted_post_right_point_raw.fif", verbose=False
        )
        averted_post_left_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-averted_post_left_point_raw.fif", verbose=False
        )
        averted_post_files_to_combine = [
            averted_post_right_odd_subject,
            averted_post_left_odd_subject,
        ...
        #  Pre-directed
        direct_pre_right_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-direct_pre_right_point_raw.fif", verbose=False
        )
        direct_pre_left_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-direct_pre_left_point_raw.fif", verbose=False
        )
        direct_pre_files_to_combine = [
            direct_pre_right_odd_subject,
            direct_pre_left_odd_subject,
        ...
        #  Post-directed
        direct_post_right_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-direct_post_right_point_raw.fif", verbose=False
        )
        direct_post_left_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-direct_post_left_point_raw.fif", verbose=False
        )
        direct_post_files_to_combine = [
            direct_post_right_odd_subject,
            direct_post_left_odd_subject,
        ...
        #  Pre-natural
        natural_pre_right_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-natural_pre_right_point_raw.fif", verbose=False
        )
        natural_pre_left_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-natural_pre_left_point_raw.fif", verbose=False
        )
        natural_pre_files_to_combine = [
            natural_pre_right_odd_subject,
            natural_pre_left_odd_subject,
        ...
        #  Post-natural
        natural_post_right_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-natural_post_right_point_raw.fif", verbose=False
        )
        natural_post_left_odd_subject = mne.io.read_raw_fif(
            "EEG-S" + str(i + 2) + "-natural_post_left_point_raw.fif", verbose=False
        )
        natural_post_files_to_combine = [
            natural_post_right_odd_subject,
            natural_post_left_odd_subject,
