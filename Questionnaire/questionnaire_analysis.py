...
print(
    f"means of SPGQ natural_pre : {np.mean(spgq_natural_pre)}, SD = {std_natural_pre}"
)
print(
    f"means of SPGQ natural_post : {np.mean(spgq_natural_post)}, SD = {std_natural_post}"
)
print(result_direct_spgq_pre_vs_spgq_post)
...
result_averted_copresence_pre_vs_copresence_post = ttest_rel(
    copresence_averted_pre, copresence_averted_post
)
...
result_direct_copresence_pre_vs_copresence_post = ttest_rel(
    copresence_direct_pre, copresence_direct_post
)
...
result_natural_copresence_pre_vs_copresence_post = ttest_rel(
    copresence_natural_pre, copresence_natural_post
)
...
result_averted_empathy_pre_vs_empathy_post = ttest_rel(
    empathy_averted_pre, empathy_averted_post
)
...
result_direct_empathy_pre_vs_empathy_post = ttest_rel(
    empathy_direct_pre, empathy_direct_post
)
...
result_natural_empathy_pre_vs_empathy_post = ttest_rel(
    empathy_natural_pre, empathy_natural_post
)
...
# %%
res_copresence = pg.rm_anova(
    dv="CoPresence",
    within="EyeGaze",
    subject="Subject",
    data=df_all_eyes_post,
    detailed=True,
)
...
# perform ANCOVA
pg.ancova(
    data=df_all_eyes, dv="SPGQTotal_Post", covar="SPGQTotal_Pre", between="EyeGaze"
)
...
# perform ANCOVA
pg.ancova(
    data=df_all_eyes, dv="CoPresence_Post", covar="CoPresence_Pre", between="EyeGaze"
)
...
pg.ancova(
    data=df_all_eyes,
    dv="NegativeFeelings_Post",
    covar="NegativeFeelings_Pre",
    between="EyeGaze",
)
...
# perform ANCOVA
pg.ancova(
    data=df_all_eyes, dv="Behavioural_Post", covar="Behavioural_Pre", between="EyeGaze"
)
...
tukey = pairwise_tukeyhsd(
    endog=df_all_eyes_post["CoPresence"],
...
# %%
post_hoc_pingouin = pg.pairwise_tests(
    dv="CoPresence",
    within="EyeGaze",
    subject="Subject",
    data=df_all_eyes_post,
