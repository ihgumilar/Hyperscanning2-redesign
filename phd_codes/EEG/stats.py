...
# %%
class Signif_Connect_EEG2_Redesign:
    ...
    def permut_sig_connection(
        ...
        path_2_preproc_files = preproc_files
        ...
        list_of_files = os.listdir(path_2_preproc_files)

        # Change working directory
        os.chdir(path_2_preproc_files)
            ...
            for idx_freq in range(len(plv_combined_freq_n_connections)):
                ...
                for idx_row, row in enumerate(
                    ...
                    for idx_col, col in enumerate(
                        ...
                        if (
                            plv_combined_freq_n_connections[idx_freq][idx_row][idx_col]
                            == 1
                        ):
                            idx_sig_connection = tuple([idx_row, idx_col])
                            # Get actual score
            ...
            for idx_freq in range(len(coh_combined_freq_n_connections)):
                ...
                for idx_row, row in enumerate(
                    ...
                    for idx_col, col in enumerate(
                        ...
                        if (
                            coh_combined_freq_n_connections[idx_freq][idx_row][idx_col]
                            == 1
                        ):
                            idx_sig_connection = tuple([idx_row, idx_col])
                            # Get actual score
